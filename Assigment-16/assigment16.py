...
db=py.connect("localhost","root","deepa014","Book")
...
cursor.execute("insert into book values(001,'looking for allen','india','fiction')")
cursor.execute("insert into titles values(001,'looking for allen','1001',101,2005)")
cursor.execute("insert into publishers values(001,'abc','delhi',10002,11001)")
cursor.execute("insert into zip_code values(001,'ambala','harayan',13303)")
...
db=py.connect("localhost","root","vijay090","library")
cursor=db.cursor()
cursor.execute("select * from book")
result=cursor.fetchall()
print(result)
